...
import static net.arcadiusmc.command.Exceptions.unknown;

import com.mojang.brigadier.StringReader;
import com.mojang.brigadier.exceptions.CommandSyntaxException;
import net.arcadiusmc.economy.market.MarketDisplay;
...
public interface EconExceptions {
   ...
   * <p>
   * Used by {@link net.arcadiusmc.commands.economy.CommandShopHistory} to state a given shop's
   * name is invalid
   */
