...
public class VoteListener implements Listener {
  ...
  public void onPlayerPostVote(PlayerPostVoteEvent event) {
    ...
    Tasks.runLater(() -> {
      Holograms.updateWithSource("votes/daily");
      Holograms.updateWithSource("votes/weekly");
      Holograms.updateWithSource("votes/monthly");
      Holograms.updateWithSource("votes/alltime");
    }, 5);
  }
