...
public final class Gates {
  ...
  public static List<GatePiece> createExitGates(
      RoomPiece parent,
  ...
  private static GatePiece generateExit(
      AbsoluteGateData parentExit,
      Random random,
      RoomPiece parent
  ) {
  ...
  public static List<GateMatch> findOpeningMatchingGates(
    ...
    for (var h : registry.entries()) {
      ...
      ListIterator<GateData> it = gates.listIterator();
      ...
      results.add(new GateMatch(h, gates, indices));
    }
  ...
  public record GateMatch(
      Holder<GateType> type,
      List<GateData> gates,
