...
import static net.arcadiusmc.punish.menus.AdminUi.TIME_MULTIPLIER;
...
class TimeSelectionPage extends MenuPage {
  ...
  enum TimeOption {
    ...
    FOREVER("Forever", -1, Material.BLACK_WOOL);
    ...
    public Component getDisplay(int multiplier) {
      ...
      if (multiplier == 1) {
        return Component.text("1 " + name);
      }

      return Component.textOfChildren(
          Text.formatNumber(multiplier),
          Component.text(" " + name + "s")
      );
    }
