 ...
 */
public class SimpleDataMap implements ItemDataMap {
   ...
   */
  public void addAll(SimpleDataMap other) {
  ...
  public Iterator<String> keyIterator() {
    return new AbstractListIterator<>() {
      ...
      @Override
      protected int size() {
        return SimpleDataMap.this.map.length;
      }
    };
  }
}