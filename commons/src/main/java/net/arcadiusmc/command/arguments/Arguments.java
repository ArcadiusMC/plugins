...
import net.arcadiusmc.command.arguments.chat.ChatArgument;
import net.arcadiusmc.command.arguments.chat.MessageArgument;
...
public interface Arguments {
  ...
  ResourceKeyArgument RESOURCE_KEY = new ResourceKeyArgument();

  ItemListArgument ITEM_LIST = new ItemListArgument();

  ItemArgumentType ITEMSTACK = new ItemArgumentType();

  SuffixedNumberArgument<Integer> MONEY = createMoneyArgument();
  ...
  private static SuffixedNumberArgument<Integer> createMoneyArgument() {
