...
public final class JsonWrapper {
  ...
  public <E extends Enum<E>> void addEnum(String name, E anum) {
    source.add(name, JsonUtils.writeEnum(anum));
  }
  ...
  public <E extends Enum<E>> E getEnum(String name, Class<E> clazz, E def) {
    ...
    return JsonUtils.readEnum(clazz, source.get(name));
  }

  public void addLocation(String name, Location location) {
    source.add(name, JsonUtils.writeLocation(location));
  }

  public Location getLocation(String name) {
    return get(name, e -> JsonUtils.readLocation(e.getAsJsonObject()));
  }
  ...
  public void addKey(String name, Key key) {
    source.add(name, JsonUtils.writeKey(key));
  }
  ...
  public void addItem(String name, ItemStack item) {
    source.add(name, JsonUtils.writeItem(item));
  }
  ...
  public ItemStack getItem(String name, ItemStack def) {
    ...
    return JsonUtils.readItem(get(name));
  }
