...
public final class Tasks {
  ...
  public static BukkitTask runSync(Runnable task) {
    return getScheduler().runTask(PluginUtil.getCallingPlugin(), task);
  }
  ...
  public static BukkitTask runLater(Runnable task, long delay) {
    return getScheduler().runTaskLater(PluginUtil.getCallingPlugin(), task, delay);
  }
  ...
  public static BukkitTask runLater(Runnable task, Duration delay) {
    return getScheduler().runTaskLater(PluginUtil.getCallingPlugin(), task, toTicks(delay));
  }
  ...
  public static BukkitTask runTimer(Runnable runnable, long delay, long interval) {
    return getScheduler().runTaskTimer(PluginUtil.getCallingPlugin(), runnable, delay, interval);
  }
  ...
  public static BukkitTask runTimer(Runnable runnable, Duration delay, Duration interval) {
    return getScheduler()
        .runTaskTimer(PluginUtil.getCallingPlugin(), runnable, toTicks(delay), toTicks(interval));
  }
  ...
  public static void runTimer(Consumer<BukkitTask> runnable, long delay, long interval) {
    getScheduler().runTaskTimer(PluginUtil.getCallingPlugin(), runnable, delay, interval);
  }
  ...
  public static void runTimer(Consumer<BukkitTask> runnable, Duration delay, Duration interval) {
    getScheduler().runTaskTimer(PluginUtil.getCallingPlugin(), runnable, toTicks(delay), toTicks(interval));
  }
  ...
  public static BukkitTask runAsync(Runnable runnable) {
    return getScheduler().runTaskAsynchronously(PluginUtil.getCallingPlugin(), runnable);
  }
  ...
  public static BukkitTask runLaterAsync(Runnable task, long delay) {
    return getScheduler().runTaskLaterAsynchronously(PluginUtil.getCallingPlugin(), task, delay);
  }
  ...
  public static BukkitTask runLaterAsync(Runnable task, Duration delay) {
    return getScheduler().runTaskLaterAsynchronously(PluginUtil.getCallingPlugin(), task, toTicks(delay));
  }
  ...
  public static BukkitTask runTimerAsync(Runnable task, long delay, long interval) {
    return getScheduler().runTaskTimerAsynchronously(PluginUtil.getCallingPlugin(), task, delay, interval);
  }
  ...
  public static BukkitTask runTimerAsync(Runnable task, Duration delay, Duration interval) {
    return getScheduler()
        .runTaskTimerAsynchronously(PluginUtil.getCallingPlugin(), task, toTicks(delay), toTicks(interval));
  }
  ...
  public static void runTimerAsync(Consumer<BukkitTask> task, long delay, long interval) {
    getScheduler().runTaskTimerAsynchronously(PluginUtil.getCallingPlugin(), task, delay, interval);
  }
