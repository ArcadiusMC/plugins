...
public final class Menus {
   ...
   */
  public static final int MAX_INV_SIZE = Slot.X_SIZE * Slot.Y_SIZE;
  ...
  public static boolean isValidSize(int size) {
    return size >= MIN_INV_SIZE && size <= MAX_INV_SIZE && size % Slot.X_SIZE == 0;
  }
  ...
  public static boolean isBorderSlot(Slot slot, int size) {
    return slot.getY() == 0
        || slot.getY() == (size / Slot.X_SIZE)
        || slot.getX() == 0
        || slot.getX() == (Slot.X_SIZE - 1);
  }
